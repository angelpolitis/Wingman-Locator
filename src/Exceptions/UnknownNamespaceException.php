<?php
    /**
	 * Project Name:    Wingman — Locator — Unknown Namespace Exception
    ...
    /**
     * Represents an unknown namespace exception.
     * @package Wingman\Locator\Exceptions
     * @author Angel Politis <info@angelpolitis.com>
     * @since 1.0
     */
    class UnknownNamespaceException extends RuntimeException implements Exception {
        /**
         * The default message of an exception.
         * @var string
         */
        protected $message = "The namespace isn't recognised.";
    }
?>