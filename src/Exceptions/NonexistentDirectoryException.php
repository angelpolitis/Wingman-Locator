<?php
    /**
	 * Project Name:    Wingman — Locator — Nonexistent Directory Exception
    ...
    /**
     * Represents a nonexistent directory exception.
     * @package Wingman\Locator\Exceptions
     * @author Angel Politis <info@angelpolitis.com>
     * @since 1.0
     */
    class NonexistentDirectoryException extends RuntimeException implements Exception {}
?>