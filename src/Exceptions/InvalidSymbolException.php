<?php
    /**
	 * Project Name:    Wingman — Locator — Invalid Symbol Exception
    ...
    /**
     * Represents an exception thrown when an invalid symbol is encountered.
     * @package Wingman\Locator\Exceptions
     * @author Angel Politis <info@angelpolitis.com>
     * @since 1.0
     */
    class InvalidSymbolException extends RuntimeException implements Exception {
        /**
         * The default message of an exception.
         * @var string
         */
        protected $message = "The value isn't valid for a symbol.";
    }
?>