<?php
    /**
	 * Project Name:    Wingman — Locator — Nonexistent File Exception
	 * Created by:      Angel Politis
	 * Creation Date:   Mar 16 2022
    ...
    /**
     * Represents a nonexistent file exception.
     * @package Wingman\Locator\Exceptions
     * @author Angel Politis <info@angelpolitis.com>
     * @since 1.0
     */
    class NonexistentFileException extends RuntimeException implements Exception {}
?>