<?php
    /**
	 * Project Name:    Wingman — Locator — Invalid Alias Exception
    ...
    /**
     * Represents an exception thrown when an invalid alias is encountered.
     * @package Wingman\Locator\Exceptions
     * @author Angel Politis <info@angelpolitis.com>
     * @since 1.0
     */
    class InvalidAliasException extends RuntimeException implements Exception {
        /**
         * The default message of an exception.
         * @var string
         */
        protected $message = "The alias isn't defined.";
    }
?>