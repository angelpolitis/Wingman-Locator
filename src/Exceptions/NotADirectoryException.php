<?php
    /**
	 * Project Name:    Wingman — Locator — Not A Directory Exception
    ...
    /**
     * Represents a not a directory exception.
     * @package Wingman\Locator\Exceptions
     * @author Angel Politis <info@angelpolitis.com>
     * @since 1.0
     */
    class NotADirectoryException extends RuntimeException implements Exception {}
?>