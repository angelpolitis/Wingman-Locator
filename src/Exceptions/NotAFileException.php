<?php
    /**
	 * Project Name:    Wingman — Locator — Not A File Exception
    ...
    /**
     * Represents a not a file exception.
     * @package Wingman\Locator\Exceptions
     * @author Angel Politis <info@angelpolitis.com>
     * @since 1.0
     */
    class NotAFileException extends RuntimeException implements Exception {}
?>